$(document).ready(function () {
    ...
    if ($('#allMediaModalContainer').length) {
        ...
        let mediaGridPreference = getCookie('mediaGridPreferences');
        ...
        $(document.body).on('click', '#shortAccessBtns button', function (event) {
            ...
            let libraryId = $(this).data('library-parent-id');
            ...
            $.post(
                ...
                function (data) {
                    if (data === 'true' || data === true) {
                        $btn.html('Le fichier a été renommé').addClass('btn-success');
        ...
        $(document.body).off('click', 'button.deleteImage').on('click', 'button.deleteImage', function (event) {
            ...
            if (confirm('Vous allez supprimer cette image')) {
                busyApp();
                let $btn = $(this);
                let idImage = $btn.data('imageid');
                let thumbWidth = $btn.data('thumbwidth');
